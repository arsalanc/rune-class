...
const EXPORTS = [
  ...
  'QUEST_DEFS', 'QUEST_STEPS', 'questStepFor', 'SCENERY_DEFS', 'NPC_DEFS', 'WALKABLE', 'World', 'mulberry32', 'makeNoise', 'Combat', 'CROPS', 'DROP_TABLES', 'GEM_CUTS', 'JEWELLERY', 'ENCHANTS', 'SAP_NAME', 'EMOTES', 'EMOTE_BY_ID', 'Events', 'EVENT_DEFS', 'EVENT_BY_ID', 'EVENT_TIER_NAME',
  'FLETCH_KNIFE', 'FLETCH_STRING', 'FLETCH_ARROW', 'CRAFTABLES',
  'Sim'
];
